/***
 * taken from http://www.source-code.biz/snippets/java/6.htm
 * modified by Alireza Nouri
 */
...
public class LRUCache<K,V> {
	...
	* @param loadFactor the loadFactor of the HashMap.
	*/
	public LRUCache (int cacheSize, float loadFactor ) {
		this.hashTableLoadFactor = loadFactor;
